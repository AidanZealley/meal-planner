...
import type { StockCheckScrollIndicatorProps } from "./StockCheckScrollIndicator.types";

export const StockCheckScrollIndicator = ({
  scrollingContainer,
  itemsContainer,
}: StockCheckScrollIndicatorProps) => {
  ...
  return (
    <div
      className={cn(
        "bg-foreground text-background sticky bottom-3 left-0 flex items-center gap-1 justify-self-center rounded-full px-4 py-2 text-center text-xs opacity-50 backdrop-blur-xs transition-opacity",
